...
import { formatDate, priceChangeColor, STOCK_STATUS_STYLES } from "@/lib/utils";
...
export default function DashboardPage() {
  ...
  const columns: ColumnDef<Drug>[] = [
    ...
    },
    {
      ...
      render: (value) => (
        <span
          className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-[11px] font-medium ${STOCK_STATUS_STYLES[value as keyof typeof STOCK_STATUS_STYLES] ??
